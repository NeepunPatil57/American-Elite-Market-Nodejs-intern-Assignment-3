    ...
    <div className="p-2 w-[400px]">
      ...
      >
        ...
        <div className="mt-10 text-xl font-semibold ">
          <button className="p-3 px-10 text-white transition-all duration-300 ease-in-out rounded-full shadow-lg bg-sky-400 hover:bg-sky-500 hover:scale-105" type="submit">Register</button>
        </div>
      </form>
    </div>
  );
